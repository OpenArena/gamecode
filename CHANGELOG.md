...
* Added a more aggressive form of g_awardpushing: it still lasts 5 seconds, but the fragged player doesn't need to be airborne, if set to 2. Also blowing yourself up with a rocket gives a point to the last attacker too.
