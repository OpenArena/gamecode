...
*/
//
// Kewl gray and blue and orange color mix.
//
//
//#define	PLAYERPORTRAITS 	// show images of player portraits
#define	USECINEMATICS			// show our stuff

#define MP_MENUMUSIC "music/menu_kewl" // music to use for menu
#define MP_BACKGROUND "ui/assets/splash22.jpg" // background of the menu
#define MP_SND_SELECT "ui/kewl/confirm.wav" // confirm noise
#define MP_SND_HOVER "ui/kewl/hover.wav" // hover noise
...
#define MP_TEXTCOLOR  0.7 0.7 0.7 1 // regular color of menu button text
#define MP_FOCUSCOLOR 0.6 0.6 0.1 1 // focus 
...
#define MP_BOX_BACK 	0.0 0.2 0.7 0.4
