...
static void CG_RegisterSounds(void) {
	...
	if ((CG_IsATeamGametype(cgs.gametype)) ||
		...
		if ((CG_UsesTeamObelisks(cgs.gametype) && !CG_UsesTheWhiteObelisk(cgs.gametype)) || cg_buildScript.integer) {
...
/*
===================
CG_UsesTheWhiteObelisk

Checks if the gametype uses the neutral obelisks.
===================
 */
qboolean CG_UsesTheWhiteObelisk(int check) {
