...
static void ServerOptions_Start( void ) {
	...
	case GT_CTF:
		trap_Cvar_SetValue( "ui_ctf_capturelimit", capturelimit );
		trap_Cvar_SetValue( "ui_ctf_timelimit", timelimit );
		trap_Cvar_SetValue( "ui_ctf_friendly", friendlyfire );
		break;
                
	case GT_1FCTF:
		trap_Cvar_SetValue( "ui_1fctf_capturelimit", capturelimit );
		trap_Cvar_SetValue( "ui_1fctf_timelimit", timelimit );
		trap_Cvar_SetValue( "ui_1fctf_friendly", friendlyfire );
		break;
                
	case GT_OBELISK:
		trap_Cvar_SetValue( "ui_overload_capturelimit", capturelimit );
...
//	trap_Cvar_SetValue( "dedicated", Com_Clamp( 0, 2, dedicated ) );
	...
	trap_Cvar_SetValue ("g_ddCaptureTime", Com_Clamp( 0, ddCaptureTime, ddCaptureTime ) );
	trap_Cvar_SetValue ("g_ddRespawnDelay", Com_Clamp( 0, ddRespawnDelay, ddRespawnDelay ) );
...
static void ServerOptions_StatusBar_ddCaptureTime( void* ptr ) {
	UI_DrawString( 320, 440, "Amount of seconds to hold both points in order to score.", UI_CENTER|UI_SMALLFONT, colorWhite );
}
...
static void ServerOptions_StatusBar_ddRespawnDelay( void* ptr ) {
	UI_DrawString( 320, 440, "Amount of seconds between scoring and beginning of new round.", UI_CENTER|UI_SMALLFONT, colorWhite );
}
...
static void ServerOptions_SetMenuItems( void ) {
	...
	case GT_CTF:
		Com_sprintf( s_serveroptions.capturelimit.field.buffer, 4, "%i", (int)Com_Clamp( 0, 100, trap_Cvar_VariableValue( "ui_ctf_capturelimit" ) ) );
	...
	case GT_1FCTF:
		Com_sprintf( s_serveroptions.capturelimit.field.buffer, 4, "%i", (int)Com_Clamp( 0, 100, trap_Cvar_VariableValue( "ui_1fctf_capturelimit" ) ) );
	...
	case GT_OBELISK:
		Com_sprintf( s_serveroptions.capturelimit.field.buffer, 4, "%i", (int)Com_Clamp( 0, 100, trap_Cvar_VariableValue( "ui_overload_capturelimit" ) ) );
	...
	case GT_ELIMINATION:
		Com_sprintf( s_serveroptions.capturelimit.field.buffer, 4, "%i", (int)Com_Clamp( 0, 999, trap_Cvar_VariableValue( "ui_elimination_capturelimit" ) ) );
	...
	case GT_CTF_ELIMINATION:
		Com_sprintf( s_serveroptions.capturelimit.field.buffer, 4, "%i", (int)Com_Clamp( 0, 999, trap_Cvar_VariableValue( "ui_ctf_elimination_capturelimit" ) ) );
	...
	case GT_LMS:
		Com_sprintf( s_serveroptions.fraglimit.field.buffer, 4, "%i", (int)Com_Clamp( 0, 999, trap_Cvar_VariableValue( "ui_lms_capturelimit" ) ) );
	...
	case GT_DOUBLE_D:
		...
		Com_sprintf( s_serveroptions.ddCaptureTime.field.buffer, 4, "%i", (int)Com_Clamp( 0, 100, trap_Cvar_VariableValue( "ui_dd_captureTime" ) ) );
		Com_sprintf( s_serveroptions.ddRespawnDelay.field.buffer, 4, "%i", (int)Com_Clamp( 0, 100, trap_Cvar_VariableValue( "ui_dd_respawnDelay" ) ) );
		break;
                
	case GT_DOMINATION:
		Com_sprintf( s_serveroptions.capturelimit.field.buffer, 4, "%i", (int)Com_Clamp( 0, 999, trap_Cvar_VariableValue( "ui_dom_fraglimit" ) ) );
	...
	case GT_POSSESSION:
		Com_sprintf( s_serveroptions.fraglimit.field.buffer, 4, "%i", (int)Com_Clamp( 0, 999, trap_Cvar_VariableValue( "ui_pos_fraglimit" ) ) );
...
static void ServerOptions_MenuInit( qboolean multiplayer ) {
	...
	if(s_serveroptions.gametype == GT_DOUBLE_D) {
		...
		s_serveroptions.ddCaptureTime.generic.type       = MTYPE_FIELD;
		s_serveroptions.ddCaptureTime.generic.name       = "New Round Delay:";
		s_serveroptions.ddCaptureTime.generic.flags      = QMF_NUMBERSONLY|QMF_PULSEIFFOCUS|QMF_SMALLFONT;
		s_serveroptions.ddCaptureTime.generic.x	         = OPTIONS_X;
		s_serveroptions.ddCaptureTime.generic.y	         = y;
		s_serveroptions.ddCaptureTime.generic.statusbar  = ServerOptions_StatusBar_ddRespawnDelay;
		s_serveroptions.ddCaptureTime.field.widthInChars = 3;
		s_serveroptions.ddCaptureTime.field.maxchars     = 3;
	}
